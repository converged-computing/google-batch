...
wrapper=/mnt/share/data/netmark-experiment-64-07/netmark_wrapper.sh
cat ${wrapper}
chmod +x ${wrapper}
...
if [ $BATCH_TASK_INDEX = 0 ]; then
  cd /mnt/share/data/netmark-experiment-64-07
  ls
  ...
  while [ ! -f "/mnt/share/data/netmark-experiment-64-07/RTT.csv" ]; do 
    sleep 30;
  done
